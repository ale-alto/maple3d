...
- Playtest fixes 2026-07-14: name tags moved BELOW the character (classic MS placement); remote throws relayed as cosmetic stars; loot changed from invisible-to-others to visible-but-owner-protected (dimmed at 45% opacity for non-owners).
