...
**M12 IMPLEMENTED 2026-07-19** (suite 81/81, live-verified) — gate: user playtest. Then **M13 jobs**: Beginner→Rogue@10 advancement (NPC + one-time thief pool roll 200–250), SP job-gated, real 1st-job kit tables (fetch each from bbb via browser pane: Nimble Body, Keen Eyes, Dark Sight, Disorder), Flash Jump leaves the early game (returns at Hermit@70).
