...
**M12 + M13 IMPLEMENTED** (M13 2026-07-20, suite 88/88, live-verified) — gate: user playtest of both (character sheet feel + the Rogue advancement/kit). Then **M14 items**: real throwing-star types with WA (Subi etc.), claw WA values replacing BASE_WA 30 interim, real potion table, mob stat pass (contact-damage formula vs the disorder wdef half).
